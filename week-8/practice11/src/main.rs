fn main(){
    ...
    //create a slice of second and third elemnts
    ...
    println!("Index 0 to 3 index sliced = {:?}", slice2);
    ...
    let slice4 = &numbers[..];
    //This means the slice starts from index 0 and goes up to index 5 (exlusive)
